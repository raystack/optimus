		...
		t.Run("should provide start and end time window for the given schedule", func(t *testing.T) {
			cases := []struct {
			...
			}{
				{
					...
					ScheduleTime:      time.Date(2022, 0o7, 0o5, 0o2, 10, 10, 10, time.UTC),
					Size:              "24h",
					Offset:            "0",
					TruncateTo:        "h",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 0o2, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0o2, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 0o2, 10, 10, 10, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0o2, 10, 10, 10, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "w",
					ExpectedStartTime: time.Date(2022, 0o7, 0o3, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o4, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 0o6, 30, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o1, 0, 0, 0, 0, time.UTC),
				},
				{
					Scenario:          "should not truncate to the previous hour if time is already truncated",
					ScheduleTime:      time.Date(2022, 0o7, 0o5, 0o2, 0o0, 0o0, 0o0, time.UTC),
					Size:              "24h",
					Offset:            "0",
					TruncateTo:        "h",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 0o2, 0, 0, 0, time.UTC),
				...
				},
				{
					...
					ScheduleTime:      time.Date(2022, 0o7, 0o5, 0o0, 0, 0, 0, time.UTC),
					Size:              "24h",
					Offset:            "0",
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 0, 0, 0, 0, time.UTC),
				...
				},
				{
					...
					ScheduleTime:      time.Date(2022, 0o7, 0o4, 0o0, 0, 0, 0, time.UTC),
					Size:              "24h",
					Offset:            "0",
					TruncateTo:        "w",
					ExpectedStartTime: time.Date(2022, 0o7, 0o3, 0, 0, 0, 0, time.UTC),
				...
				},
				{
					...
					ScheduleTime:      time.Date(2022, 0o7, 0o1, 0, 0, 0, 0, time.UTC),
					Size:              "24h",
					Offset:            "0",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 0o6, 30, 0, 0, 0, 0, time.UTC),
				...
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o3, 23, 30, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 5, 0o1, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 7, 0o1, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 0o5, 30, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o1, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o4, 23, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "0",
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					TruncateTo:        "d",
					ExpectedStartTime: time.Date(2022, 0o7, 0o5, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o7, 0o6, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "-1M",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 0o5, 0o1, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o6, 0o1, 0, 0, 0, 0, time.UTC),
				},
				{
					...
					Offset:            "-1M24h",
					TruncateTo:        "M",
					ExpectedStartTime: time.Date(2022, 0o4, 30, 0, 0, 0, 0, time.UTC),
					ExpectedEndTime:   time.Date(2022, 0o5, 30, 0, 0, 0, 0, time.UTC),
				},
				{
