...
plugin:
  ...
  artifacts:
    ...
    # any http uri
    - https://github.com/raystack/optimus/releases/download/v0.2.5/optimus_0.2.5_linux_arm64.tar.gz
```
...
apiversion: []
image: docker.io/raystack/optimus-task-bq2bq-executor:0.1.0-SNAPSHOT-27cb56f
