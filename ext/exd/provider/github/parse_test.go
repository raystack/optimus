...
func TestParse(t *testing.T) {
	...
	t.Run("should return metadata with provider github", func(t *testing.T) {
	...
	t.Run("should return metadata with the same owner name as expected", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor"
	...
	t.Run("should return metadata with the same repo name as expected", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor"
	...
	t.Run("should return metadata with the same tag name as expected", func(t *testing.T) {
	...
	t.Run("should return metadata with api path latest release if tag is not specified", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor"
	...
	t.Run("should return metadata with api path selected tag release if tag is specified", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor@v1.0.0"
	...
	t.Run("should return metadata with the same dir path as expected", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor@v1.0.0"
	...
	t.Run("should return metadata with the same command name as expected", func(t *testing.T) {
		remotePath := "github.com/gojek/optimus-extension-valor@v1.0.0"
