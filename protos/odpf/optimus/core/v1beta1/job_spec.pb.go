...
var file_odpf_optimus_core_v1beta1_job_spec_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0xaa, 0x01, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61,
	...
	0x69, 0x6d, 0x75, 0x73, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x4a, 0x6f, 0x62, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x32, 0xdf, 0x0f, 0x0a, 0x17, 0x4a, 0x6f, 0x62, 0x53,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0xd8, 0x01, 0x0a, 0x16, 0x43, 0x72,
...
var file_odpf_optimus_core_v1beta1_job_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_odpf_optimus_core_v1beta1_job_spec_proto_goTypes = []interface{}{
	...
	nil,                                         // 35: odpf.optimus.core.v1beta1.JobSpecification.AssetsEntry
	nil,                                         // 36: odpf.optimus.core.v1beta1.JobSpecification.LabelsEntry
	(*JobSpecification_Behavior)(nil),           // 37: odpf.optimus.core.v1beta1.JobSpecification.Behavior
	(*JobSpecification_Behavior_Retry)(nil),     // 38: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Retry
	(*JobSpecification_Behavior_Notifiers)(nil), // 39: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers
	nil,                         // 40: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers.ConfigEntry
	nil,                         // 41: odpf.optimus.core.v1beta1.HttpDependency.HeadersEntry
	nil,                         // 42: odpf.optimus.core.v1beta1.HttpDependency.ParamsEntry
	nil,                         // 43: odpf.optimus.core.v1beta1.GetDeployJobsStatusResponse.UnknownDependenciesEntry
	(*Log)(nil),                 // 44: odpf.optimus.core.v1beta1.Log
...
var file_odpf_optimus_core_v1beta1_job_spec_proto_depIdxs = []int32{
	...
	44, // 1: odpf.optimus.core.v1beta1.DeployJobSpecificationResponse.log_status:type_name -> odpf.optimus.core.v1beta1.Log
	17, // 2: odpf.optimus.core.v1beta1.AddJobSpecificationsRequest.specs:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	17, // 3: odpf.optimus.core.v1beta1.CreateJobSpecificationRequest.spec:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	17, // 4: odpf.optimus.core.v1beta1.GetJobSpecificationResponse.spec:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	17, // 5: odpf.optimus.core.v1beta1.ListJobSpecificationResponse.jobs:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	17, // 6: odpf.optimus.core.v1beta1.CheckJobSpecificationRequest.job:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	17, // 7: odpf.optimus.core.v1beta1.CheckJobSpecificationsRequest.jobs:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	44, // 8: odpf.optimus.core.v1beta1.CheckJobSpecificationsResponse.log_status:type_name -> odpf.optimus.core.v1beta1.Log
	21, // 9: odpf.optimus.core.v1beta1.JobSpecification.config:type_name -> odpf.optimus.core.v1beta1.JobConfigItem
	18, // 10: odpf.optimus.core.v1beta1.JobSpecification.dependencies:type_name -> odpf.optimus.core.v1beta1.JobDependency
	35, // 11: odpf.optimus.core.v1beta1.JobSpecification.assets:type_name -> odpf.optimus.core.v1beta1.JobSpecification.AssetsEntry
	20, // 12: odpf.optimus.core.v1beta1.JobSpecification.hooks:type_name -> odpf.optimus.core.v1beta1.JobSpecHook
	36, // 13: odpf.optimus.core.v1beta1.JobSpecification.labels:type_name -> odpf.optimus.core.v1beta1.JobSpecification.LabelsEntry
	37, // 14: odpf.optimus.core.v1beta1.JobSpecification.behavior:type_name -> odpf.optimus.core.v1beta1.JobSpecification.Behavior
	23, // 15: odpf.optimus.core.v1beta1.JobSpecification.metadata:type_name -> odpf.optimus.core.v1beta1.JobMetadata
	19, // 16: odpf.optimus.core.v1beta1.JobDependency.http_dependency:type_name -> odpf.optimus.core.v1beta1.HttpDependency
	41, // 17: odpf.optimus.core.v1beta1.HttpDependency.headers:type_name -> odpf.optimus.core.v1beta1.HttpDependency.HeadersEntry
	42, // 18: odpf.optimus.core.v1beta1.HttpDependency.params:type_name -> odpf.optimus.core.v1beta1.HttpDependency.ParamsEntry
	21, // 19: odpf.optimus.core.v1beta1.JobSpecHook.config:type_name -> odpf.optimus.core.v1beta1.JobConfigItem
	0,  // 20: odpf.optimus.core.v1beta1.JobEvent.type:type_name -> odpf.optimus.core.v1beta1.JobEvent.Type
	45, // 21: odpf.optimus.core.v1beta1.JobEvent.value:type_name -> google.protobuf.Struct
	24, // 22: odpf.optimus.core.v1beta1.JobMetadata.resource:type_name -> odpf.optimus.core.v1beta1.JobSpecMetadataResource
	26, // 23: odpf.optimus.core.v1beta1.JobMetadata.airflow:type_name -> odpf.optimus.core.v1beta1.JobSpecMetadataAirflow
	25, // 24: odpf.optimus.core.v1beta1.JobSpecMetadataResource.request:type_name -> odpf.optimus.core.v1beta1.JobSpecMetadataResourceConfig
	25, // 25: odpf.optimus.core.v1beta1.JobSpecMetadataResource.limit:type_name -> odpf.optimus.core.v1beta1.JobSpecMetadataResourceConfig
	44, // 26: odpf.optimus.core.v1beta1.RefreshJobsResponse.log_status:type_name -> odpf.optimus.core.v1beta1.Log
	31, // 27: odpf.optimus.core.v1beta1.GetDeployJobsStatusResponse.failures:type_name -> odpf.optimus.core.v1beta1.DeployJobFailure
	43, // 28: odpf.optimus.core.v1beta1.GetDeployJobsStatusResponse.unknown_dependencies:type_name -> odpf.optimus.core.v1beta1.GetDeployJobsStatusResponse.UnknownDependenciesEntry
	17, // 29: odpf.optimus.core.v1beta1.GetJobSpecificationsResponse.jobs:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	34, // 30: odpf.optimus.core.v1beta1.GetJobSpecificationsResponse.job_specification_responses:type_name -> odpf.optimus.core.v1beta1.JobSpecificationResponse
	17, // 31: odpf.optimus.core.v1beta1.JobSpecificationResponse.job:type_name -> odpf.optimus.core.v1beta1.JobSpecification
	38, // 32: odpf.optimus.core.v1beta1.JobSpecification.Behavior.retry:type_name -> odpf.optimus.core.v1beta1.JobSpecification.Behavior.Retry
	39, // 33: odpf.optimus.core.v1beta1.JobSpecification.Behavior.notify:type_name -> odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers
	46, // 34: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Retry.delay:type_name -> google.protobuf.Duration
	0,  // 35: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers.on:type_name -> odpf.optimus.core.v1beta1.JobEvent.Type
	40, // 36: odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers.config:type_name -> odpf.optimus.core.v1beta1.JobSpecification.Behavior.Notifiers.ConfigEntry
	1,  // 37: odpf.optimus.core.v1beta1.JobSpecificationService.DeployJobSpecification:input_type -> odpf.optimus.core.v1beta1.DeployJobSpecificationRequest
	5,  // 38: odpf.optimus.core.v1beta1.JobSpecificationService.CreateJobSpecification:input_type -> odpf.optimus.core.v1beta1.CreateJobSpecificationRequest
	3,  // 39: odpf.optimus.core.v1beta1.JobSpecificationService.AddJobSpecifications:input_type -> odpf.optimus.core.v1beta1.AddJobSpecificationsRequest
	7,  // 40: odpf.optimus.core.v1beta1.JobSpecificationService.GetJobSpecification:input_type -> odpf.optimus.core.v1beta1.GetJobSpecificationRequest
	32, // 41: odpf.optimus.core.v1beta1.JobSpecificationService.GetJobSpecifications:input_type -> odpf.optimus.core.v1beta1.GetJobSpecificationsRequest
	9,  // 42: odpf.optimus.core.v1beta1.JobSpecificationService.DeleteJobSpecification:input_type -> odpf.optimus.core.v1beta1.DeleteJobSpecificationRequest
	11, // 43: odpf.optimus.core.v1beta1.JobSpecificationService.ListJobSpecification:input_type -> odpf.optimus.core.v1beta1.ListJobSpecificationRequest
	13, // 44: odpf.optimus.core.v1beta1.JobSpecificationService.CheckJobSpecification:input_type -> odpf.optimus.core.v1beta1.CheckJobSpecificationRequest
	15, // 45: odpf.optimus.core.v1beta1.JobSpecificationService.CheckJobSpecifications:input_type -> odpf.optimus.core.v1beta1.CheckJobSpecificationsRequest
	27, // 46: odpf.optimus.core.v1beta1.JobSpecificationService.RefreshJobs:input_type -> odpf.optimus.core.v1beta1.RefreshJobsRequest
	29, // 47: odpf.optimus.core.v1beta1.JobSpecificationService.GetDeployJobsStatus:input_type -> odpf.optimus.core.v1beta1.GetDeployJobsStatusRequest
	2,  // 48: odpf.optimus.core.v1beta1.JobSpecificationService.DeployJobSpecification:output_type -> odpf.optimus.core.v1beta1.DeployJobSpecificationResponse
	6,  // 49: odpf.optimus.core.v1beta1.JobSpecificationService.CreateJobSpecification:output_type -> odpf.optimus.core.v1beta1.CreateJobSpecificationResponse
	4,  // 50: odpf.optimus.core.v1beta1.JobSpecificationService.AddJobSpecifications:output_type -> odpf.optimus.core.v1beta1.AddJobSpecificationsResponse
	8,  // 51: odpf.optimus.core.v1beta1.JobSpecificationService.GetJobSpecification:output_type -> odpf.optimus.core.v1beta1.GetJobSpecificationResponse
	33, // 52: odpf.optimus.core.v1beta1.JobSpecificationService.GetJobSpecifications:output_type -> odpf.optimus.core.v1beta1.GetJobSpecificationsResponse
	10, // 53: odpf.optimus.core.v1beta1.JobSpecificationService.DeleteJobSpecification:output_type -> odpf.optimus.core.v1beta1.DeleteJobSpecificationResponse
	12, // 54: odpf.optimus.core.v1beta1.JobSpecificationService.ListJobSpecification:output_type -> odpf.optimus.core.v1beta1.ListJobSpecificationResponse
	14, // 55: odpf.optimus.core.v1beta1.JobSpecificationService.CheckJobSpecification:output_type -> odpf.optimus.core.v1beta1.CheckJobSpecificationResponse
	16, // 56: odpf.optimus.core.v1beta1.JobSpecificationService.CheckJobSpecifications:output_type -> odpf.optimus.core.v1beta1.CheckJobSpecificationsResponse
	28, // 57: odpf.optimus.core.v1beta1.JobSpecificationService.RefreshJobs:output_type -> odpf.optimus.core.v1beta1.RefreshJobsResponse
	30, // 58: odpf.optimus.core.v1beta1.JobSpecificationService.GetDeployJobsStatus:output_type -> odpf.optimus.core.v1beta1.GetDeployJobsStatusResponse
