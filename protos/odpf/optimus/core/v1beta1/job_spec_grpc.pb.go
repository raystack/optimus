...
func (c *jobSpecificationServiceClient) JobInspect(ctx context.Context, in *JobInspectRequest, opts ...grpc.CallOption) (*JobInspectResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/odpf.optimus.core.v1beta1.JobSpecificationService/JobInspect", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobSpecificationServiceClient) UpdateJobSpecifications(ctx context.Context, in *UpdateJobSpecificationsRequest, opts ...grpc.CallOption) (*UpdateJobSpecificationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/odpf.optimus.core.v1beta1.JobSpecificationService/UpdateJobSpecifications", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _JobSpecificationService_JobInspect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.core.v1beta1.JobSpecificationService/JobInspect",
	}
...
func _JobSpecificationService_UpdateJobSpecifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/odpf.optimus.core.v1beta1.JobSpecificationService/UpdateJobSpecifications",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
