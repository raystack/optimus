...
Read our [contributing guide](https://github.com/odpf/optimus/blob/main/docs/docs/contribute/contributing.md) to learn about our development process, how to propose bugfixes and improvements, and how to build and test your changes to Optimus.
