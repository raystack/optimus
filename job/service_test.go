...
func TestService(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		t.Run("should create a new JobSpec and store in repository", func(t *testing.T) {
			...
			svc := job.NewService(repoFac, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil)
	...
	t.Run("Sync", func(t *testing.T) {
		...
		t.Run("should successfully store job specs for the requested project", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, depenResolver, priorityResolver, projJobSpecRepoFac, nil, nil)
		...
		t.Run("should batch dependency resolution errors if any for all jobs", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil)
			err := svc.Sync(ctx, namespaceSpec, nil)
			assert.NotNil(t, err)
	...
	t.Run("KeepOnly", func(t *testing.T) {
		...
		t.Run("should keep only provided specs and delete rest", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil)
	...
	t.Run("Delete", func(t *testing.T) {
		...
		t.Run("should successfully delete a job spec", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil)
	...
	t.Run("GetByDestination", func(t *testing.T) {
		t.Run("should return job spec given a destination", func(t *testing.T) {
			...
			svc := job.NewService(nil, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil)
	...
	t.Run("GetDownstream", func(t *testing.T) {
		t.Run("should return downstream job specs", func(t *testing.T) {
			...
			svc := job.NewService(nil, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil)
	...
	t.Run("Refresh", func(t *testing.T) {
		...
		t.Run("should successfully refresh job specs for the whole project", func(t *testing.T) {
			...
			err := svc.Refresh(ctx, projSpec, []models.NamespaceJobNamePair{}, nil)
		...
		t.Run("should successfully refresh job specs for a namespace", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, depenResolver,
				priorityResolver, projJobSpecRepoFac, nil, namespaceService)
			err := svc.Refresh(ctx, projSpec, namespaceJobNamePairs, nil)
		...
		t.Run("should successfully refresh job specs for the selected jobs", func(t *testing.T) {
			...
			jobSpecRepoFac.On("New", namespaceSpec).Return(jobSpecRepo)
			jobSpecRepo.On("GetByName", ctx, jobSpecsBase[0].Name).Return(jobSpecsBase[0], nil)
		...
		t.Run("should failed when unable to fetch job specs when refreshing selected jobs", func(t *testing.T) {
			...
			jobSpecRepoFac.On("New", namespaceSpec).Return(jobSpecRepo)
			jobSpecRepo.On("GetByName", ctx, jobSpecsBase[0].Name).Return(models.JobSpec{}, errors.New(errorMsg))
		...
		t.Run("should not failed refresh when one of dependency resolution failed", func(t *testing.T) {
			...
			depenResolver.On("ResolveAndPersist", ctx, projSpec, jobSpecsBase[0], nil).Return(nil)
			depenResolver.On("ResolveAndPersist", ctx, projSpec, jobSpecsBase[1], nil).Return(errors.New(errorMsg))
		...
		t.Run("should failed when unable to get job specs when preparing refreshed dependencies", func(t *testing.T) {
			projectJobSpecRepo := new(mock.ProjectJobSpecRepository)
			defer projectJobSpecRepo.AssertExpectations(t)
		...
		t.Run("should failed when unable to fetch dependencies", func(t *testing.T) {
			projectJobSpecRepo := new(mock.ProjectJobSpecRepository)
			defer projectJobSpecRepo.AssertExpectations(t)
			...
			assert.Equal(t, fmt.Sprintf("failed to fetch job dependencies: %s", errorMsg), err.Error())
		})
		t.Run("should failed when unable to resolve priority", func(t *testing.T) {
			projectJobSpecRepo := new(mock.ProjectJobSpecRepository)
			defer projectJobSpecRepo.AssertExpectations(t)
		...
		t.Run("should failed when unable to get namespace spec for deployment", func(t *testing.T) {
			projectJobSpecRepo := new(mock.ProjectJobSpecRepository)
			defer projectJobSpecRepo.AssertExpectations(t)
			...
			projectJobSpecRepo.On("GetJobNamespaces", ctx).Return(map[string][]string{}, errors.New(errorMsg))

			svc := job.NewService(nil, batchScheduler, nil, dumpAssets, depenResolver,
				priorityResolver, projJobSpecRepoFac, nil, namespaceService)
			err := svc.Refresh(ctx, projSpec, []models.NamespaceJobNamePair{}, nil)

			assert.Equal(t, fmt.Sprintf("failed to retrieve namespace to job mapping: %s", errorMsg), err.Error())
		})
		t.Run("should failed when unable to deploy jobs", func(t *testing.T) {
			projectJobSpecRepo := new(mock.ProjectJobSpecRepository)
			defer projectJobSpecRepo.AssertExpectations(t)
			...
			batchScheduler.On("DeployJobs", ctx, namespaceSpec, jobSpecsAfterPriorityResolve, nil).Return(errors.New(errorMsg))
