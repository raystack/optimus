...
func TestService(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		t.Run("should create a new JobSpec and store in repository", func(t *testing.T) {
			...
			svc := job.NewService(repoFac, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil, nil, nil)
		...
		t.Run("should fail if saving to repo fails", func(t *testing.T) {
			...
			svc := job.NewService(repoFac, nil, nil, dumpAssets, nil, nil, nil, nil, nil, nil, nil)
			err := svc.Create(ctx, namespaceSpec, jobSpec)
			assert.NotNil(t, err)
		})
	})
	...
	t.Run("Check", func(t *testing.T) {
		...
		t.Run("should skip checking for dependencies for task that doesn't support this mod", func(t *testing.T) {
			...
			service := job.NewService(nil, batchScheduler, nil, dumpAssets, nil, nil, nil, nil, nil, nil, nil)
	...
	t.Run("Sync", func(t *testing.T) {
		...
		t.Run("should successfully store job specs for the requested project", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, dependencyResolver, priorityResolver, projJobSpecRepoFac, nil, nil, nil, nil)
		...
		t.Run("should ignore the failure of dependency resolution of different namespaces", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, depenResolver, priorityResolver, projJobSpecRepoFac, nil, nil, nil, nil)
			err := svc.Sync(ctx, namespaceSpec, nil)
			assert.Nil(t, err)
		})
		...
		t.Run("should batch dependency resolution errors if any for all jobs", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil, nil, nil)
			err := svc.Sync(ctx, namespaceSpec, nil)
			assert.NotNil(t, err)
	...
	t.Run("KeepOnly", func(t *testing.T) {
		...
		t.Run("should keep only provided specs and delete rest", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil, nil, nil)
	...
	t.Run("GetTaskDependencies", func(t *testing.T) {
		...
		t.Run("should successfully generate destination and dependencies for job task", func(t *testing.T) {
			...
			svc := job.NewService(nil, nil, nil, dumpAssets, nil, nil, nil, nil, nil, nil, nil)
	...
	t.Run("Delete", func(t *testing.T) {
		...
		t.Run("should successfully delete a job spec", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil, nil, nil)
	...
	t.Run("GetByDestination", func(t *testing.T) {
		t.Run("should return job spec given a destination", func(t *testing.T) {
			...
			svc := job.NewService(nil, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil, nil, nil)
	...
	t.Run("GetDownstream", func(t *testing.T) {
		t.Run("should return downstream job specs", func(t *testing.T) {
			...
			svc := job.NewService(nil, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil, nil, nil)
	...
	t.Run("Refresh", func(t *testing.T) {
		...
		t.Run("should successfully refresh job specs for the selected jobs", func(t *testing.T) {
			...
			svc := job.NewService(jobSpecRepoFac, batchScheduler, nil, dumpAssets, dependencyResolver,
				priorityResolver, nil, nil, namespaceService, projectService, deployer)
			err := svc.Refresh(ctx, projSpec.Name, namespaceJobNamePairs, nil)
