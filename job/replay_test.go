...
func TestReplay(t *testing.T) {
	...
	t.Run("ReplayDryRun", func(t *testing.T) {
		t.Run("should fail if unable to fetch jobSpecs from project jobSpecRepo", func(t *testing.T) {
			...
			jobSvc := job.NewService(nil, nil, nil, dumpAssets, nil, nil, projJobSpecRepoFac, nil, nil, nil, nil, nil, nil, nil)
		...
		t.Run("should fail if unable to resolve jobs using dependency resolver", func(t *testing.T) {
			...
			jobSvc := job.NewService(nil, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, nil, nil, nil, nil, nil, nil, nil)
			replayRequest := models.ReplayRequest{
				Job:                         specs[spec1],
				Start:                       replayStart,
				End:                         replayEnd,
	...
	t.Run("Replay", func(t *testing.T) {
		...
		t.Run("should fail if replay manager throws an error", func(t *testing.T) {
			...
			jobSvc := job.NewService(nil, nil, nil, dumpAssets, depenResolver, nil, projJobSpecRepoFac, replayManager, nil, nil, nil, nil, nil, nil)
	...
	t.Run("GetReplayStatus", func(t *testing.T) {
		...
		t.Run("should fail if unable to fetch replay spec", func(t *testing.T) {
			...
			jobSvc := job.NewService(nil, nil, nil, dumpAssets, nil, nil, nil, replayManager, nil, nil, nil, nil, nil, nil)
