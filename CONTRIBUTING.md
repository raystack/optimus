...
3. Increase the version numbers in any examples files and the README.md to the new version if 
   needed that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
