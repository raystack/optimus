...
func (d *DatastoreService) GetBackupResourceDetail(ctx context.Context, projectSpec models.ProjectSpec, datastoreName string, id uuid.UUID) (models.BackupSpec, error) {
