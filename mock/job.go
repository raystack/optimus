...
// OptimusDependencyGetter is an autogenerated mock type for the OptimusDependencyGetter type
type OptimusDependencyGetter struct {
	mock.Mock
}

// GetOptimusDependencies provides a mock function with given fields: _a0, _a1
func (_m *OptimusDependencyGetter) GetOptimusDependencies(_a0 context.Context, _a1 models.JobSpecFilter) ([]models.OptimusDependency, error) {
	ret := _m.Called(_a0, _a1)
...
type mockConstructorTestingTNewOptimusDependencyGetter interface {
	mock.TestingT
	Cleanup(func())
}

// NewOptimusDependencyGetter creates a new instance of OptimusDependencyGetter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewOptimusDependencyGetter(t mockConstructorTestingTNewOptimusDependencyGetter) *OptimusDependencyGetter {
	mock := &OptimusDependencyGetter{}
	mock.Mock.Test(t)
