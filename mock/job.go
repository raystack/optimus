...
// GetByDestinations provides a mock function with given fields: _a0, _a1
func (_m *ProjectJobSpecRepository) GetByDestinations(_a0 context.Context, _a1 []string) ([]models.JobSpec, error) {
	ret := _m.Called(_a0, _a1)
