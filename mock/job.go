...
// GetJobSpecifications provides a mock function with given fields: _a0, _a1
func (_m *ResourceManager) GetJobSpecifications(_a0 context.Context, _a1 models.JobSpecFilter) ([]models.JobSpec, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []models.JobSpec
	if rf, ok := ret.Get(0).(func(context.Context, models.JobSpecFilter) []models.JobSpec); ok {
		r0 = rf(_a0, _a1)
	} else if ret.Get(0) != nil {
		r0 = ret.Get(0).([]models.JobSpec)
	}
...
// ExternalDependencyGetter is an autogenerated mock type for the ExternalDependencyGetter type
type ExternalDependencyGetter struct {
	mock.Mock
}

// GetExternalDependency provides a mock function with given fields: _a0, _a1
func (_m *ExternalDependencyGetter) GetExternalDependency(_a0 context.Context, _a1 models.JobSpecFilter) (models.ExternalDependency, error) {
	ret := _m.Called(_a0, _a1)

	var r0 models.ExternalDependency
	if rf, ok := ret.Get(0).(func(context.Context, models.JobSpecFilter) models.ExternalDependency); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(models.ExternalDependency)
	}
...
type mockConstructorTestingTNewExternalDependencyGetter interface {
	mock.TestingT
	Cleanup(func())
}

// NewExternalDependencyGetter creates a new instance of ExternalDependencyGetter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewExternalDependencyGetter(t mockConstructorTestingTNewExternalDependencyGetter) *ExternalDependencyGetter {
	mock := &ExternalDependencyGetter{}
	mock.Mock.Test(t)
