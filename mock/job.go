...
func (srv *JobService) ResolveDependecy(ctx context.Context, resourceDestinations []string, currentSpec models.JobSpec, progressObserver progress.Observer) ([]models.JobSpec, error) {
	args := srv.Called(ctx, resourceDestinations, currentSpec, progressObserver)
	return args.Get(0).([]models.JobSpec), args.Error(1)
}
...
func (_m *DependencyResolver) GetJobsByResourceDestinations(ctx context.Context, resourceDestinations []string, subjectJobName string, progressObserver progress.Observer) ([]models.JobSpec, error) {
	args := _m.Called(ctx, resourceDestinations, subjectJobName, progressObserver)
	return args.Get(0).([]models.JobSpec), args.Error(1)
}
